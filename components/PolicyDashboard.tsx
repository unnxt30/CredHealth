...
//   Alert,
// } from 'react-native';
// import { Shield, ArrowLeft, Plus, X } from 'react-native-feather';

// const POLICY_STORAGE_KEY = '@blockchain_policy_data';

// const API_BASE_URL = 'http://10.79.8.134:3000';

// // New policy interface for type safety
// interface Policy {
//   id: string;
//   policyID: string;
//   userID: string;
...
//           currentHealthPoints: policyDetails.currentHealthPoints,
//           rollingAverage: policyDetails.rollingAverage,
//           k: policyDetails.k,
